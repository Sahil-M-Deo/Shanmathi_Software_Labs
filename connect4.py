...
def play(screen,clock,font,username1,username2,turn,game_mode,blitz_turn_time):
    ...
    if game_mode=="blitz":
        ...
        T1=Timer(screen,font,left_x,y_start-scale_h(40),game.cell_size,game.cell_size*game.boardHEIGHT,blitz_turn_time)
        T2=Timer(screen,font,right_x,y_start-scale_h(40),game.cell_size,game.cell_size*game.boardHEIGHT,blitz_turn_time)
        #
